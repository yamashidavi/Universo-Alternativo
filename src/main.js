  ...
  <main>
    <section class="hero">
      <div class="hero-conteudo">
        ...
        <h1>
          Bem-vindo ao<br>
          <span>Universo Alternativo</span>
        </h1>

        <p>
          Jogos, animes, música, cultura retrô, filmes,
          tecnologia e tudo aquilo que torna a cultura
          pop simplesmente incrível.
        </p>

        <div class="hero-botoes">
          <a href="#categorias" class="botao principal">
            Explorar o Universo
          </a>

          <a href="#destaques" class="botao secundario">
            Ver destaques
          </a>
        </div>
      </div>
    ...
    <section id="destaques" class="destaques">
      <div>
        ...
        <p>
          ...
          Novas áreas, conteúdos e experiências
          serão adicionados ao longo da jornada.
        </p>
      </div>
